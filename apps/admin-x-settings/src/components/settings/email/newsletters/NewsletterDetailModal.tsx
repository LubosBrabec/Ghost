        ...
        if (newsletter.status === 'active') {
            NiceModal.show(ConfirmationModal, {
                ...
                prompt: <>
                    ...
                    {activeNewsletters.length === 1 && (
                         <p><br></br><strong>Warning:</strong>  <strong>{newsletter.name}</strong> is your only active newsletter. Archiving will automatically disable newsletter sending.</p>
                    )}
                </>,
                okLabel: 'Archive',
                okColor: 'red',
